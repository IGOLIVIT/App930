...
class CoreDataStack {
    ...
    func deleteCal(withCalLName name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<CalModel> = CalModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "calLName == %@", name)
    ...
    func deleteContest(withConLift name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<ContModel> = ContModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "conLift == %@", name)
